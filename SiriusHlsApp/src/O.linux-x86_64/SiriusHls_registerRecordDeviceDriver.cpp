...
/* Generated from ../O.Common/SiriusHls.dbd */
...
int SiriusHls_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/usr/apps/siriushls/SiriusHls";
...
/* SiriusHls_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"SiriusHls_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    SiriusHls_registerRecordDeviceDriver(*iocshPpdbbase);
}
